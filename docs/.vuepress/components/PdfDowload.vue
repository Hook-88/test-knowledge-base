...
const downloadPDF = async () => {
    ...
    try {
        ...
        if (footer) {
            ...
            footerClone.style.paddingRight = '10px'; // Add padding
            footerClone.style.paddingLeft = '10px';
            ...
            footerClone.style.maxWidth = '100%';
            footerClone.style.width = '100%'; // Explicit width
            footerClone.style.boxSizing = 'border-box';

            // Apply word wrapping to all footer elements
            const footerElements = footerClone.querySelectorAll('*');
            ...
            // Specifically handle the paragraph
            const footerP = footerClone.querySelector('p');
            if (footerP) {
                footerP.style.textAlign = 'left';
                footerP.style.margin = '0';
                footerP.style.padding = '0 10px'; // Add horizontal padding
                footerP.style.width = '100%';
            }

            // Remove or hide the image if present
            const footerImg = footerClone.querySelector('img');
            if (footerImg) {
                footerImg.remove();
            }
